export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Conversar com o Sítio Emanuel pelo WhatsApp"
      className="fixed bottom-4 right-4 z-50 flex h-13 w-13 items-center justify-center rounded-full border border-white/20 bg-[#22c55e] text-white shadow-[0_16px_45px_rgba(34,197,94,.3)] transition hover:-translate-y-1 hover:bg-[#27ce64] sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
    >
